...
│
├── models/                      # trained artifacts (created by pipeline.py)
│   ├── catboost_model.cbm
│   ├── lgb_model.txt
│   ├── xgb_model.json
│   ├── lr_model.joblib
...
4. **If you change the threshold or calibration**, refit `models/isotonic_calibrator.joblib` (`models/dispute_threshold.json` is auto-generated by the same training driver). Update `LIMITATIONS.md` §"Probability threshold" and §9 of this file.
